...
const PRICE_RANGES = {
	...
	[Rarity.LEGENDARY]: { min: 400, max: 2500, multiplierMin: 0.5, multiplierMax: 2 },
};
...
function App(): ReactElement {
	...
	const handleImageSubmit = async (): Promise<void> => {
		...
		if (state.rarity === null || state.useOpenAI === null) {
			return;
		}
		const currentCount = Number.parseInt(state.count, 10);
