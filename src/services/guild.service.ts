...
export class GuildService {
	...
	public async ensureGuildExists(discordSnowflake: string): Promise<Guild> {
		...
		try {
			...
			throw new Error(`Failed to ensure guild exists: ${error instanceof Error ? error.message : 'Unknown error'}`, { cause: error });
		}
	}
	...
	public async getGuildByDiscordSnowflake(discordSnowflake: string): Promise<Guild | null> {
		...
		try {
			...
			throw new Error(`Failed to get guild: ${error instanceof Error ? error.message : 'Unknown error'}`, { cause: error });
		}
	}
	...
	public async updateFishingCooldown(
		...
		try {
			...
			throw new Error(`Failed to update fishing cooldown: ${error instanceof Error ? error.message : 'Unknown error'}`, { cause: error });
		}
	}
