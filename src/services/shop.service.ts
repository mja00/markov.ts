...
export class ShopService {
	...
	> {
		...
		try {
			...
			throw new Error(`Failed to get shop items: ${error instanceof Error ? error.message : 'Unknown error'}`, { cause: error });
		}
	}
	...
	public async getShopItemById(shopId: string): Promise<{
		...
		try {
			...
			throw new Error(`Failed to get shop item: ${error instanceof Error ? error.message : 'Unknown error'}`, { cause: error });
		}
	}
	...
	public async addToInventory(userId: string, itemId: string, count: number = 1): Promise<Inventory> {
		...
		try {
			...
			throw new Error(`Failed to add to inventory: ${error instanceof Error ? error.message : 'Unknown error'}`, { cause: error });
		}
	}
	...
	> {
		...
		try {
			...
			throw new Error(`Failed to get inventory: ${error instanceof Error ? error.message : 'Unknown error'}`, { cause: error });
		}
	}
	...
	> {
		...
		try {
			...
			throw new Error(`Failed to get purchase history: ${error instanceof Error ? error.message : 'Unknown error'}`, { cause: error });
		}
	}
