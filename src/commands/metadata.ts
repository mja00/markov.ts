...
export const ChatCommandMetadata: {
	...
	AUTOMATIONS: {
		type: ApplicationCommandType.ChatInput,
		name: Lang.getRef('chatCommands.automations', Language.Default),
		name_localizations: Lang.getRefLocalizationMap('chatCommands.automations'),
		description: Lang.getRef('commandDescs.automations', Language.Default),
		description_localizations: Lang.getRefLocalizationMap('commandDescs.automations'),
		dm_permission: true,
		default_member_permissions: undefined,
		options: [
			{ ...Args.AUTOMATIONS_ACTION, required: true },
			{ ...Args.AUTOMATIONS_FEATURE, required: false },
			{ ...Args.AUTOMATIONS_TIMEZONE, required: false },
			{ ...Args.AUTOMATIONS_QUIET_START, required: false },
			{ ...Args.AUTOMATIONS_QUIET_END, required: false },
			{ ...Args.AUTOMATIONS_FREQUENCY, required: false },
			{ ...Args.AUTOMATIONS_DESTINATION, required: false },
		],
	},
};
