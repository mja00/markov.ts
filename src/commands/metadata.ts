		...
		options: [
			...
			{ type: 3,
				...
				choices: [
					...
					{ name: 'Personal reminders', value: 'personalReminders' },
				] },
			{ type: 3, name: 'timezone', description: 'IANA timezone, e.g. America/New_York.', required: false },
			{ type: 3, name: 'quiet_start', description: 'Quiet hours start (HH:mm).', required: false },
			{ type: 3, name: 'quiet_end', description: 'Quiet hours end (HH:mm).', required: false },
			{ type: 3,
				name: 'frequency',
			...
			{ type: 7, name: 'destination', description: 'Destination channel.', required: false },
		],
	},
};
